...
<style>
    ...
    .progress-wrap {
        ...
        display: flex; align-items: flex-start;
        justify-content: space-between;
        /* no padding-top — track calculated from here */
    }

    .progress-track {
        position: absolute;
        top: 22px;                   /* half of 44px dot */
        left: calc(10% + 22px);     /* right edge of first dot */
        right: calc(10% + 22px);    /* left edge of last dot */
        height: 2px;
    ...
    /* DONE — solid olive, white filled check */
    .step-dot--done {
    ...
    /* CURRENT — solid umber, champagne icon */
    .step-dot--current {
        background: var(--umber);
        box-shadow: 0 0 0 7px rgba(75,54,33,0.12), 0 4px 14px rgba(75,54,33,0.25);
    }
    .step-dot--current i { color: var(--champagne); font-size: 20px; }

    /* FUTURE — solid ivory so line is hidden, muted */
    .step-dot--future {
        background: var(--ivory);
    ...
    /* show/hide: done → filled check; others → step icon */
...
<div class="orders-wrap">
        ...
        <div class="order-card">
            ...
            <div class="order-card-top">
                ...
                <div class="order-card-actions">
                    ...
                    <a href="{{ route('shop.orders.show', $order) }}" class="order-view-link">View details →</a>
                </div>
            </div>
    ...
    @empty
        <div class="empty-state">
            ...
            <a href="{{ route('shop.index') }}" class="btn-shop">Browse the shop</a>
        </div>
    @endforelse
